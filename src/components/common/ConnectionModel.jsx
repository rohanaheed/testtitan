...
const ConnectionModel = ({ popup, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div class="text-sm text-gray-500 px-28 border-gray-200 mb-79">
        <ul class="rounded-8 card-shadow bg-gray-50 w-full mx-auto my-60 border">
          <li onClick={() => connect('meta')} class="wallet-item flex items-center justify-between px-26 py-20 border-b cursor-pointer">
            <div class=" flex justify-between text-gray-700 items-center gap-5 font-normal text-16 cursor-pointer transition-all">
              <img class="w-24" src="/assets/metamask.webp" alt="" />
              MetaMask</div>
            <div class="bg-primary text-gray-800 px-16 py-3 rounded-20">
              Popular
            </div>
          </li>
      ...
      <div onClick={() => connect('meta')} className="bg-gray-900 py-18 px-28 mt-44 cursor-pointer">
