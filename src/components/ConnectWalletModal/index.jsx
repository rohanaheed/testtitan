...
const ConnectWalletModal = ({isOpen, setIsOpen}) => {
    ...
    return (
        ...
        <h2 className="text-center text-24 text-gray-800 mt-58"> Connect Wallet </h2>
            <p className="text-gray-600 mb-34 text-center px-24 lg:px-72"> Connect with one of our wallet providers or create new one</p>
            ...
            <li class="wallet-item flex items-center justify-between px-26 py-20 border-b cursor-pointer"><div class=" flex justify-between text-gray-700 items-center gap-5 font-normal text-16 cursor-pointer transition-all"><img class="w-24" src="/assets/metamask.webp" alt="" />MetaMask</div><div class="bg-primary text-gray-800 px-16 py-3 rounded-20">Popular</div></li>
